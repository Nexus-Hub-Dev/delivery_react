  ...
  return (
    <div className="category-form-page">
      <div className="category-form-heading">
        <span className="section-kicker">Organização do cardápio</span>
        <h1>{id === undefined ? "Adicionar" : "Editar"} categoria</h1>
        <p>Preencha os dados que serão exibidos no cardápio.</p>
      </div>
      ...
      <form className="category-form" onSubmit={gerarNovaCategoria}>
        <div className="category-form-fields">
          ...
          <label className="category-icon-field" htmlFor="icone">
            Ícone
            <div className="category-icon-row">
              <select
                id="icone"
                name="icone"
                value={categoria.icone || "fork-knife"}
                onChange={atualizarEstado}
              >
                <option value="fork-knife">Garfo e faca</option>
                <option value="hamburger">Hambúrguer</option>
                <option value="pizza">Pizza</option>
                <option value="massa">Massas</option>
                <option value="bowl">Saladas</option>
                <option value="fish">Japonesa</option>
                <option value="brasileira">Comida brasileira</option>
                <option value="vegana">Vegana</option>
                <option value="cookie">Doces</option>
              ...
              <span className="category-icon-preview">
                <IconeCategoria
                  icone={categoria.icone || "fork-knife"}
                  tamanho={26}
                />
              </span>
            </div>
