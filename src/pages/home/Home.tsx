    ...
    <div className="relative mx-auto grid min-h-[650px] max-w-7xl items-center gap-14 px-6 py-20 lg:grid-cols-2 lg:px-10">
      ...
      <div className="max-w-xl">
        ...
        <p className="mt-6 text-lg leading-8 text-[#6D647C]">
          ...
          acompanhamento logístico. Substitua o controle manual por um fluxo estruturado e digital.
        </p>
  ...
  >
    ...
    <div className="mx-auto max-w-3xl px-6 text-center">
      ...
      <p className="mt-5 text-lg leading-8 text-[#6D647C]">
        ...
        Categorize fluxos (Aguardando, Em Preparo, Em Rota, Entregue ou Cancelado)
        e garanta que nenhuma entrega atrase ou seja esquecida, além de facilitar 
        a automação de relatórios de vendas.
      </p>
    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-10">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-5 leading-7 text-[#6D647C]">
          ...
          conjunto para transformar a logística do seu estabelecimento através da tecnologia.
        </p>
